...
* {
    ...
    font-family: 'poppins', sans-serif; /* Amazing font */
    ...
    box-shadow: 0 4px 6px rgba(0, 0, 0, 0.2); /* Add shadow for a modern look */
...
<script src="${pageContext.request.contextPath}/dashboard.js"></script>
    ...
    <div class="main-content">
        ...
        <button class="custom-btn" onclick="window.location.href='/recruiter/getinterviewlist?id=${jobid}&name=${jobname}'" >Interview Candidates List</button>
